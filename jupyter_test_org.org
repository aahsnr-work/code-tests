...
#+AUTHOR: Test Suite
#+PROPERTY: header-args:python :tangle jupyter_test_org.py
...
: ============================================================
: Python Version: 3.13.9 (main, Oct 14 2025, 13:52:31) [GCC 14.3.0]
: Python Executable: /nix/store/7gl4khq26h625mpqzkiiqsify3hclar1-python3-3.13.9/bin/python
: Platform: Linux-6.17.8-2-cachyos-x86_64-with-glibc2.40
: Architecture: x86_64
: ============================================================
...
: 0    Alice   25   92.5      NYC
: 1      Bob   30   88.0       LA
: 2  Charlie   35   95.5  Chicago
: 3    David   28   79.0  Houston
: 4      Eve   32   91.5  Phoenix
...
#+RESULTS:
:RESULTS:
: /tmp/ipykernel_771123/2331300373.py:29: FutureWarning:
:
