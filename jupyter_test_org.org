...
#+AUTHOR: Test Suite
#+PROPERTY: header-args:jupyter-python :session py :tangle jupyter_test_org.py
...
#+begin_src jupyter-python :session py :tangle jupyter_test_org.py
...
✓ numpy           - Available
============================================================
⚠ Missing packages: scipy, sklearn, seaborn
============================================================
#+end_example
